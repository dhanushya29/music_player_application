...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { description: @playlist.description, title: @playlist.title, user_id: @playlist.user_id } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { description: @playlist.description, title: @playlist.title, user_id: @playlist.user_id } }
